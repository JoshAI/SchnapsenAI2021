...
class TestState(TestCase):
	...
	def test_game_full(self):
		...
		for i in range(10000):
			...
			if winner == 1:
				wins +=1
		print(wins)		#added a bracket around the print-statement
	...
	def test_seed_same(self):
		for i in range(1,1000):
			...
			if s.get_deck().get_card_states() != s1.get_deck().get_card_states() or s.whose_turn() != s.whose_turn():
				...
				print(s.get_deck().get_card_states())	#added a bracket around the print-statement
				print(s1.get_deck().get_card_states())	#added a bracket around the print-statement
	...
	def test_exchange_visible(self):
		...
		moves = s.moves()
		print(s.get_deck().get_card_states())	#added a bracket around the print-statement
		print(moves)							#added a bracket around the print-statement
		print(s.get_deck().get_trump_suit())	#added a bracket around the print-statement
